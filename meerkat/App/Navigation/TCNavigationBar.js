...
import {width, indexTxtColor,Size} from '../Themes/theme'
...
export default class TCNavigationBar extends React.Component {
    ...
    render() {
        return (
            <Image style={styles.navBarStyle} source={ require('../Images/top_bg_750.png') }
                   resizeMode={'cover'}>
                {/*左边*/}
                {this.renderGetBackButton()}
                {/*中间*/}
                <TouchableOpacity disabled={this.props.midCall ? false : true} onPress={()=>this.props.midCall()}>
                    <View style={[{width: width - 180, justifyContent: 'center', alignItems: 'center'}, this.props.titleStyle]}>
