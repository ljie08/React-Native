...
//            }
            ...
            [self.store requestAuthorizationToShareTypes:writeDataTypes readTypes:readDataTypes completion:^(BOOL success, NSError * _Nullable error) {
                if (compltion != nil) {
            ...
            NSDictionary *userInfo = [NSDictionary dictionaryWithObject:@"ios < 8.0" forKey:NSLocalizedDescriptionKey];
